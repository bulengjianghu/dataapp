...
| 文档 | 用途 |
|---|---|
| [阶段需求.md](../../需求/01-单表单编辑器/阶段需求.md) | 确认功能范围与验收边界 |
| [表单编辑器前端设计.md](../../设计/01-单表单编辑器/前端设计/表单编辑器前端设计.md) | 作为前端主设计依据 |
| [组件树设计.md](../../设计/01-单表单编辑器/前端设计/组件树设计.md) | 统一节点树、store、删除策略 |
| [组件配置项解耦设计.md](../../设计/01-单表单编辑器/前端设计/组件配置项解耦设计.md) | 属性面板动态渲染依据 |
| [栅格与水平布局设计.md](../../设计/01-单表单编辑器/前端设计/栅格与水平布局设计.md) | 画布布局与容器布局实现依据 |
| [拖拽落点判定设计.md](../../设计/01-单表单编辑器/前端设计/拖拽落点判定设计.md) | 拖拽判定与落点写入依据 |
| [编辑态运行态组件设计.md](../../设计/01-单表单编辑器/前端设计/编辑态运行态组件设计.md) | 编辑态/预览态组件分层依据 |
